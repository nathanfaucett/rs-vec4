...
#[inline(always)]
pub fn length_values_sq<'a, T: Num>(x: T, y: T, z: T, w: T) -> T {
    x * x + y * y + z * z + w * w
}
#[test]
...
#[inline(always)]
pub fn length_values<'a, T: Num>(x: T, y: T, z: T, w: T) -> T {
...
#[inline(always)]
pub fn inv_length_values<'a, T: Num>(x: T, y: T, z: T, w: T) -> T {
    let lsq = length_values_sq(x, y, z, w);
...
#[inline(always)]
pub fn dot<'a, T: Num>(a: &'a [T; 4], b: &'a [T; 4]) -> T {
...
#[inline(always)]
pub fn length<'a, T: Num>(out: &'a [T; 4]) -> T {
...
#[inline(always)]
pub fn normalize<'a, T: Num>(out: &'a mut [T; 4], a: &'a [T; 4]) -> &'a mut [T; 4] {
    sdiv(out, a, length(a))
}
#[test]
fn test_normalize() {
